...
import { addRegistration } from '../../api/elpApi';
...
useEffect(() => {
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.title}>New Vehicle Registration</Text>
      ...
      <TouchableOpacity style={styles.submitButton} onPress={submitRegistration}>
...
const styles = StyleSheet.create({
  ...
  title: { color: 'white', fontSize: 20, fontWeight: 'bold', alignSelf: 'flex-start', marginBottom: 20 },
